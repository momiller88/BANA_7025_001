...
shinyApp(
  ...
  server = function(input, output) {selected_data_tab_2 <- reactive({
    ...
    ggplot(selected_data_tab_2(), aes(price_range_value)) + geom_histogram() + scale_x_continuous(name = "price range value") + ggtitle("Histogram of Datafiniti Items Selected", subtitle = "Select the province, price type, and price range value you want to evaluate")
  }
)
  },
