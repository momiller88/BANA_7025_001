...
#Creates shiny table and histogram#
shinyApp(
  ui = fluidPage(selectInput("province", "Select the province you want to evaluate:", choices = sort(unique(datafiniti_tab$province)), multiple = TRUE),
...
server = function(input, output) {selected_data_tab_2 <- reactive({
    ...
    ggplot(selected_data_tab_2(), aes(price_range_value)) + 
        ...
        ggtitle("Histogram of Datafiniti Items Selected", subtitle = "Select the province and price type you want to evaluate")})},
  options = list(height = 1200))
```
