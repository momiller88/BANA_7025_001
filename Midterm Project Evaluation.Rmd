...
Below is the code and the final cleaned dataset for barstool. 

```{r}
datatable(barstool_variable_name)
```
...
#Creates summary data frame of the character variables for barstool#
...
```{r}
#Creates summary data table for the barstool numeric variables#
