...
The next items I wanted to change were the data types for zip, price_level, provider_review_count, review_stats_all_count, review_stats_community_count, review_stats_critic_count, and review_stats_dave_count. 
