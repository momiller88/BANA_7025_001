...
The first item we wanted to evaluate was the missing items in the datasets. The code below allows us to see the percentage of missing items from each of the datasets. 
...
The rest of the variables in the barstool we evaulated. We found them to be fine after looking at their tables and the histograms. 
...
shinyApp(
  ui = fluidPage(
    ...
    plotOutput("data" , height = 500, width = 500)
),
